...
export interface ApiConsultationLeadConsultationLead
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    areaAndFloors: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detailNote: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::consultation-lead.consultation-lead'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ctaText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Xem th\u00EAm'>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customSpecifications: Schema.Attribute.Text;
    detailsArea: Schema.Attribute.String;
    detailsClient: Schema.Attribute.String;
    detailsLocation: Schema.Attribute.String;
    detailsScale: Schema.Attribute.String;
    detailsYear: Schema.Attribute.String;
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    addressNorth: Schema.Attribute.String;
    addressSouth: Schema.Attribute.String;
    companyName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'C\u00D4NG TY C\u1ED4 PH\u1EA6N KI\u1EBEN TR\u00DAC V\u00C0 X\u00C2Y D\u1EF0NG GAMMA HOME'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    feedbackImage: Schema.Attribute.Media<'images'>;
    hotline: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'0827.972.555'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::setting.setting'
    ...
    slogan: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'T\u1EADn t\u00E2m trong t\u1EEBng vi\u00EAn g\u1EA1ch \u2013 V\u1EEFng tr\u1ECDn ni\u1EC1m tin trong t\u1EEBng m\u00E1i nh\u00E0'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::consultation-lead.consultation-lead': ApiConsultationLeadConsultationLead;
